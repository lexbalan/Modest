...
define %Int @main() {
	...
	%2 = alloca %Char32, align 4
	store %Char32 128000, %Char32* %2
	%3 = load %Char32, %Char32* %2
	%4 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([14 x i8]* @.str2 to [0 x i8]*), %Char32 %3)
	%5 = alloca %Char8, align 1
	store %Char8 233, %Char8* %5
	%6 = load %Char8, %Char8* %5
	%7 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([12 x i8]* @.str3 to [0 x i8]*), %Char8 %6)
	ret %Int 0
}
