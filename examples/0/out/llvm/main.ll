...
; -- strings --
@.str1 = private constant [17 x i8] [i8 72, i8 101, i8 108, i8 108, i8 111, i8 32, i8 87, i8 111, i8 114, i8 108, i8 100, i8 33, i8 32, i8 37, i8 102, i8 10, i8 0]
; -- endstrings --
define %Int @main() {
	%1 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([17 x i8]* @.str1 to [0 x i8]*), %Float64 0.3000000000000000)
	ret %Int 0
}
