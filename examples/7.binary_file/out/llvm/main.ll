...
endif_0:
	...
	; (see Makefile)
	%7 = getelementptr inbounds %Chunk, %Chunk* %6, %Int32 0, %Int32 0
	%8 = bitcast [100 x %Char]* %7 to [0 x %Char]*
	%9 = call [0 x %Char]* @strcpy([0 x %Char]* %8, [0 x %Char]* bitcast ([3 x i8]* @str5 to [0 x i8]*))
	%10 = getelementptr inbounds %Chunk, %Chunk* %6, %Int32 0, %Int32 1
...
endif_0:
	...
	%10 = getelementptr inbounds %Chunk, %Chunk* %6, %Int32 0, %Int32 0
	%11 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([16 x i8]* @str11 to [0 x i8]*), [100 x %Char]* %10)
	%12 = getelementptr inbounds %Chunk, %Chunk* %6, %Int32 0, %Int32 1
