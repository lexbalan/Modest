...
define %Str8* @fsm_state_no_name(%fsm_FSM* %fsm, %Int32 %state_no) {
	%1 = getelementptr [16 x %fsm_StateDesc], %fsm_FSM* %fsm, %Int32 4
	%2 = getelementptr %fsm_StateDesc, [16 x %fsm_StateDesc]* %1, %Int32 %state_no
	%3 = getelementptr [8 x %Char8], %fsm_StateDesc* %2, %Int32 0
	%4 = bitcast [8 x %Char8]* %3 to %Str8*
	ret %Str8* %4
}

define void @fsm_switch(%fsm_FSM* %fsm, %Int32 %state) {
	%1 = getelementptr %Int32, %fsm_FSM* %fsm, %Int32 2
	store %Int32 %state, %Int32* %1
	%2 = getelementptr %Int32, %fsm_FSM* %fsm, %Int32 3
...
then_2:
	%14 = getelementptr %fsm_Handler, %fsm_StateDesc* %8, %Int32 1
	%15 = load %fsm_Handler, %fsm_Handler* %14
	call void %15(%fsm_FSM* %fsm)
	br label %endif_2
endif_2:
	%16 = getelementptr %Int32, %fsm_FSM* %fsm, %Int32 1
	store %Int32 %6, %Int32* %16
	%17 = getelementptr %Int32, %fsm_FSM* %fsm, %Int32 3
	store %Int32 1, %Int32* %17
	br label %endif_0
else_0:
	%18 = getelementptr %Int32, %fsm_FSM* %fsm, %Int32 3
	%19 = load %Int32, %Int32* %18
	%20 = icmp eq %Int32 %19, 1
	br %Bool %20 , label %then_3, label %else_3
then_3:
	%21 = getelementptr %Int32, %fsm_FSM* %fsm, %Int32 1
	%22 = load %Int32, %Int32* %21
	%23 = getelementptr [16 x %fsm_StateDesc], %fsm_FSM* %fsm, %Int32 4
	%24 = getelementptr %fsm_StateDesc, [16 x %fsm_StateDesc]* %23, %Int32 %22
	%25 = getelementptr %fsm_Handler, %fsm_StateDesc* %24, %Int32 2
...
then_4:
	%28 = getelementptr %fsm_Handler, %fsm_StateDesc* %24, %Int32 2
...
then_7:
	%42 = getelementptr %fsm_Handler, %fsm_StateDesc* %36, %Int32 3
	%43 = load %fsm_Handler, %fsm_Handler* %42
	call void %43(%fsm_FSM* %fsm)
	br label %endif_7
endif_7:
	%44 = getelementptr %Int32, %fsm_FSM* %fsm, %Int32 3
