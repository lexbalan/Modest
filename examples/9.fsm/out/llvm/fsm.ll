...
then_1:
    ...
    %9 = call i32(%ConstCharStr*, ...) @printf (%ConstCharStr* bitcast ([10 x i8]* @str1 to [0 x i8]*), [8 x i8]* %8)
    br label %endif_1
endif_1:
...
then_6:
    ...
    %39 = call i32(%ConstCharStr*, ...) @printf (%ConstCharStr* bitcast ([9 x i8]* @str2 to [0 x i8]*), [8 x i8]* %38)
    br label %endif_6
endif_6:
