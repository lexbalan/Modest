...
define %ctypes64_Int @main() {
	%1 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([22 x i8]* @str1 to [0 x i8]*))
	%2 = alloca %Int32, align 4
	%3 = alloca %Int32, align 4
	%4 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([10 x i8]* @str2 to [0 x i8]*))
	%5 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @scanf(%stdio_ConstCharStr* bitcast ([3 x i8]* @str3 to [0 x i8]*), %Int32* %2)
	%6 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([10 x i8]* @str4 to [0 x i8]*))
	%7 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @scanf(%stdio_ConstCharStr* bitcast ([3 x i8]* @str5 to [0 x i8]*), %Int32* %3)
	%8 = load %Int32, %Int32* %2
	%9 = load %Int32, %Int32* %3
	%10 = icmp sgt %Int32 %8, %9
	br %Bool %10 , label %then_0, label %else_0
then_0:
	%11 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([7 x i8]* @str6 to [0 x i8]*))
	br label %endif_0
else_0:
...
then_1:
	%15 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([7 x i8]* @str7 to [0 x i8]*))
	br label %endif_1
else_1:
	%16 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([8 x i8]* @str8 to [0 x i8]*))
	br label %endif_1
endif_1:
	br label %endif_0
endif_0:
