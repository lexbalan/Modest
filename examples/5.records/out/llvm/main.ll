...
define internal void @ptr_example() {
	...
	; access by pointer
	%3 = getelementptr inbounds %Point, %Point* %2, %Int32 0, %Int32 0
	store %Float 10.0000000000000000, %Float* %3
	%4 = getelementptr inbounds %Point, %Point* %2, %Int32 0, %Int32 1
	store %Float 20.0000000000000000, %Float* %4
	%5 = getelementptr inbounds %Point, %Point* %2, %Int32 0, %Int32 0
	%6 = load %Float, %Float* %5
	%7 = getelementptr inbounds %Point, %Point* %2, %Int32 0, %Int32 1
