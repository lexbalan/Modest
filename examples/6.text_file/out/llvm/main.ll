...
define void @read_example() {
	...
	br i1 %3 , label %then_0, label %endif_0
then_0:
	%4 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([29 x i8]* @str8 to [0 x i8]*), %Str8* bitcast ([9 x i8]* @str1 to [0 x i8]*))
	ret void
	br label %endif_0
endif_0:
	%6 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([21 x i8]* @str9 to [0 x i8]*), %Str8* bitcast ([9 x i8]* @str1 to [0 x i8]*))
	br label %again_1
again_1:
	br i1 1 , label %body_1, label %break_1
body_1:
	%7 = call i32 @fgetc(%File* %2)
	%8 = icmp eq i32 %7, -1
...
then_1:
	...
	br label %endif_1
endif_1:
	%10 = call i32 @putchar(i32 %7)
	br label %again_1
break_1:
	%11 = call i32 @fclose(%File* %2)
	ret void
}
