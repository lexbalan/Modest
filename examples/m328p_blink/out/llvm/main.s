...
.LBB1_5:                                ; %body_1
                                        ;   in Loop: Header=BB1_2 Depth=1
	sts	delay_counter+3, r25
	sts	delay_counter+2, r24
	sts	delay_counter+1, r25
	sts	delay_counter, r24
.LBB1_6:                                ; %again_2
                                        ;   Parent Loop BB1_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	lds	r20, delay_counter
	lds	r21, delay_counter+1
	lds	r22, delay_counter+2
	lds	r23, delay_counter+3
	ldi	r18, 1
	cpi	r20, -112
	cpc	r21, r18
	cpc	r22, r24
...
.LBB1_9:                                ; %body_2
	...
	lds	r19, delay_counter+1
	lds	r20, delay_counter+2
	lds	r21, delay_counter+3
	subi	r18, 255
	sbci	r19, 255
	sbci	r20, 255
	sbci	r21, 255
	sts	delay_counter+1, r19
	sts	delay_counter, r18
	sts	delay_counter+3, r21
	sts	delay_counter+2, r20
	rjmp	.LBB1_6
.LBB1_10:                               ; %break_1
	adiw	r28, 4
	in	r0, 63
...
.Lfunc_end2:
	...
	.type	delay_counter,@object           ; @delay_counter
	.section	.bss,"aw",@nobits
	.globl	delay_counter
delay_counter:
	.long	0                               ; 0x0
	.size	delay_counter, 4
