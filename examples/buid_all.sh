cd 1.* && echo "BUILD:" "$PWD" && make && make C && make CM && cd .. && \
cd 2.* && echo "BUILD:" "$PWD" && make && make C && make CM && cd .. && \
cd 3.* && echo "BUILD:" "$PWD" && make && make C && make CM && cd .. && \
cd 4.* && echo "BUILD:" "$PWD" && make && make C && make CM && cd .. && \
