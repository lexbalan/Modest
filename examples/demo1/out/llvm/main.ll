...
then_0:
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([37 x i8]* @str1 to [0 x i8]*), %Int32 %1, %Int32 5)
	br label %endif_0
else_0:
	%4 = icmp sgt %Int32 %1, 5
	br %Bool %4 , label %then_1, label %else_1
then_1:
	%5 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([40 x i8]* @str2 to [0 x i8]*), %Int32 %1, %Int32 5)
	br label %endif_1
else_1:
	%6 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([38 x i8]* @str3 to [0 x i8]*), %Int32 %1, %Int32 5)
	br label %endif_1
endif_1:
	br label %endif_0
endif_0:
...
body_1:
	%2 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([28 x i8]* @str4 to [0 x i8]*), %Int32 %min, %Int32 %max)
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @scanf(%stdio_ConstCharStr* bitcast ([3 x i8]* @str5 to [0 x i8]*), %Int32* %1)
	%4 = load %Int32, %Int32* %1
	%5 = icmp slt %Int32 %4, %min
	br %Bool %5 , label %then_0, label %else_0
then_0:
	%6 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([43 x i8]* @str6 to [0 x i8]*), %Int32 %min)
	br label %again_1
	br label %endif_0
else_0:
...
then_1:
	%10 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([40 x i8]* @str7 to [0 x i8]*), %Int32 %max)
	br label %again_1
	br label %endif_1
else_1:
	br label %break_1
