...
then_0:
	%3 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([37 x i8]* @str1 to [0 x i8]*), i32 %1, i32 5)
	br label %endif_0
else_0:
	%4 = icmp sgt i32 %1, 5
	br i1 %4 , label %then_1, label %else_1
then_1:
	%5 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([40 x i8]* @str2 to [0 x i8]*), i32 %1, i32 5)
	br label %endif_1
else_1:
	%6 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([38 x i8]* @str3 to [0 x i8]*), i32 %1, i32 5)
	br label %endif_1
endif_1:
	br label %endif_0
endif_0:
...
body_1:
	%2 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([28 x i8]* @str4 to [0 x i8]*), i32 %min, i32 %max)
	%3 = call i32 (%ConstCharStr*, ...) @scanf(%ConstCharStr* bitcast ([3 x i8]* @str5 to [0 x i8]*), i32* %1)
	%4 = load i32, i32* %1
	%5 = icmp slt i32 %4, %min
	br i1 %5 , label %then_0, label %else_0
then_0:
	%6 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([43 x i8]* @str6 to [0 x i8]*), i32 %min)
	br label %again_1
	br label %endif_0
else_0:
	%8 = load i32, i32* %1
...
then_1:
	%10 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([40 x i8]* @str7 to [0 x i8]*), i32 %max)
	br label %again_1
	br label %endif_1
else_1:
	br label %break_1
