...
endif_0:
	...
	%16 = call %Int (%Int, %Struct_sockaddr*, %Socklen_t) @connect(%Int %1, %Struct_sockaddr* %14, %Socklen_t 16)
	store %Int %16, %Int* %15
	%17 = load %Int, %Int* %15
...
then_1:
	...
	br label %endif_1
endif_1:
	%19 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([25 x i8]* @str6 to [0 x i8]*))
	%20 = call %File* (%ConstCharStr*, %ConstCharStr*) @fopen(%ConstCharStr* bitcast ([9 x i8]* @str7 to [0 x i8]*), %ConstCharStr* bitcast ([2 x i8]* @str8 to [0 x i8]*))
	%21 = icmp eq %File* %20, null
	br i1 %21 , label %then_2, label %endif_2
then_2:
	call void (%ConstCharStr*) @perror(%ConstCharStr* bitcast ([26 x i8]* @str9 to [0 x i8]*))
	call void (%Int) @exit(%Int 1)
	br label %endif_2
endif_2:
	call void (%File*, %Int) @send_file(%File* %20, %Int %1)
	%22 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([33 x i8]* @str10 to [0 x i8]*))
	%23 = call %Int (%Int) @close(%Int %1)
