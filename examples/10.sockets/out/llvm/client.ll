...
; -- endstrings --
define internal %Bool @client_send_file(%File* %fp, %Int %sockfd) {
...
endif_0:
	...
	%13 = call %Int @connect(%Int %1, %Struct_sockaddr* %11, %SocklenT 16)
	store %Int %13, %Int* %12
	%14 = load %Int, %Int* %12
...
then_2:
	...
	br label %endif_2
endif_2:
	%19 = call %Bool @client_send_file(%File* %17, %Int %1)
