...
; -- endstrings --
define internal %Bool @send_file(%stdio_File* %fp, %ctypes64_Int %sockfd) {
	%1 = alloca [1024 x %Char8], align 1
	br label %again_1
again_1:
	%2 = bitcast [1024 x %Char8]* %1 to %stdio_CharStr*
	%3 = call %stdio_CharStr* @fgets(%stdio_CharStr* %2, %ctypes64_Int 1024, %stdio_File* %fp)
	%4 = icmp ne %stdio_CharStr* %3, null
	br %Bool %4 , label %body_1, label %break_1
body_1:
	%5 = bitcast [1024 x %Char8]* %1 to i8*
	%6 = call %ctypes64_SSizeT @send(%ctypes64_Int %sockfd, i8* %5, %ctypes64_SizeT 1024, %ctypes64_Int 0)
	%7 = icmp eq %ctypes64_SSizeT %6, -1
...
then_0:
	call void @perror(%stdio_ConstCharStr* bitcast ([20 x i8]* @str1 to [0 x i8]*))
	call void @exit(%ctypes64_Int 1)
	br label %endif_0
endif_0:
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([27 x i8]* @str2 to [0 x i8]*))
	...
	%7 = call %socket_InAddrT @inet_addr([0 x %ctypes64_ConstChar]* bitcast ([10 x i8]* @str3 to [0 x i8]*))
	...
	%13 = call %ctypes64_Int @connect(%ctypes64_Int %1, %socket_Struct_sockaddr* %11, %socket_SocklenT 16)
...
then_1:
	call void @perror(%stdio_ConstCharStr* bitcast ([24 x i8]* @str4 to [0 x i8]*))
	call void @exit(%ctypes64_Int 1)
	br label %endif_1
endif_1:
	%16 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([25 x i8]* @str5 to [0 x i8]*))
	%17 = call %stdio_File* @fopen(%stdio_ConstCharStr* bitcast ([9 x i8]* @str6 to [0 x i8]*), %stdio_ConstCharStr* bitcast ([2 x i8]* @str7 to [0 x i8]*))
	%18 = icmp eq %stdio_File* %17, null
	br %Bool %18 , label %then_2, label %endif_2
then_2:
	call void @perror(%stdio_ConstCharStr* bitcast ([26 x i8]* @str8 to [0 x i8]*))
	call void @exit(%ctypes64_Int 1)
	br label %endif_2
endif_2:
	%19 = call %Bool @send_file(%stdio_File* %17, %ctypes64_Int %1)
	br %Bool %19 , label %then_3, label %else_3
then_3:
	%20 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([33 x i8]* @str9 to [0 x i8]*))
	br label %endif_3
else_3:
	call void @perror(%stdio_ConstCharStr* bitcast ([26 x i8]* @str10 to [0 x i8]*))
	br label %endif_3
endif_3:
	%21 = call %ctypes64_Int @close(%ctypes64_Int %1)
	%22 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([34 x i8]* @str11 to [0 x i8]*))
	ret %ctypes64_Int 0
}
