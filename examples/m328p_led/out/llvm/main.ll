...
declare %Bool @animation_isBusy(%animation_AnimationState* %astate)
declare void @animation_stop(%animation_AnimationState* %astate)
declare void @animation_startt(%animation_AnimationState* %astate)
declare void @animation_start(%animation_AnimationState* %astate, %animation_Animation* %a)
declare void @animation_step(%animation_AnimationState* %astate)
; -- end print imports --
; -- strings --
; -- endstrings --

@astate = global %animation_AnimationState zeroinitializer
