...
to C11, LLVM IR, or back to Modest. This page explains how it works and
how to work on it. For the directory map see [STRUCTURE.md](./STRUCTURE.md);
for HLIR class internals see
[../agents/claude/hlir-internals.md](../agents/claude/hlir-internals.md).
