...
then_0:
	%9 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([13 x i8]* @str3 to [0 x i8]*))
	br label %endif_0
else_0:
	%10 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([13 x i8]* @str4 to [0 x i8]*))
	br label %endif_0
endif_0:
	ret i32 0
}
