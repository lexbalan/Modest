...
@str2 = private constant [15 x i8] [i8 37, i8 100, i8 32, i8 37, i8 37, i8 32, i8 37, i8 100, i8 32, i8 61, i8 32, i8 37, i8 100, i8 10, i8 0]
...
define internal void @divtest() {
	...
	%7 = sdiv %Int32 %5, %6
	%8 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([14 x i8]* @str1 to [0 x i8]*), %Int32 %3, %Int32 %4, %Int32 %7)
	%9 = load %Int32, %Int32* %1
	%10 = load %Int32, %Int32* %2
	%11 = load %Int32, %Int32* %1
	%12 = load %Int32, %Int32* %2
	%13 = srem %Int32 %11, %12
	%14 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([15 x i8]* @str2 to [0 x i8]*), %Int32 %9, %Int32 %10, %Int32 %13)
	ret void
}
