...
define void @print_ab(i32 %a, i32 %b) {
	%1 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([22 x i8]* @str2 to [0 x i8]*), i32 %a, i32 %b)
	ret void
}
...
define i32 @main() {
	%1 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([11 x i8]* @str3 to [0 x i8]*))
	...
	%3 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([19 x i8]* @str4 to [0 x i8]*), i32 1, i32 2, i32 %2)
	%4 = alloca i32 (i32, i32)*, align 8
	store i32 (i32, i32)* @sum, i32 (i32, i32)** %4
	; call function with two arguments and return value
	%5 = load i32 (i32, i32)*, i32 (i32, i32)** %4
	%6 = call i32 %5(i32 1, i32 2)
	%7 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([20 x i8]* @str5 to [0 x i8]*), i32 1, i32 2, i32 %6)
	ret i32 0
}
