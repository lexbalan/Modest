...
define internal void @print_ab(%Int32 %a, %Int32 %b) {
	%1 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([22 x i8]* @str2 to [0 x i8]*), %Int32 %a, %Int32 %b)
	ret void
}
...
define %ctypes64_Int @main() {
	%1 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([11 x i8]* @str3 to [0 x i8]*))
	...
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([19 x i8]* @str4 to [0 x i8]*), %Int32 1, %Int32 2, %Int32 %2)
	...
	%7 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([20 x i8]* @str5 to [0 x i8]*), %Int32 1, %Int32 2, %Int32 %6)
	ret %ctypes64_Int 0
}
