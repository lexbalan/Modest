...
static uint32_t initMagic[8] = (uint32_t [8]){0x6A09E667, 0xBB67AE85, 0x3C6EF372, 0xA54FF53A, 0x510E527F, 0x9B05688C, 0x1F83D9AB, 0x5BE0CD19
};
...
static SHA256_TestData test0 = (SHA256_TestData){
...
static SHA256_TestData test1 = (SHA256_TestData){
...
#define nTests  2
static SHA256_TestData *sha256_tests[nTests] = (SHA256_TestData *[nTests]){(SHA256_TestData *)&test0, (SHA256_TestData *)&test1};
