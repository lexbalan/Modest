...
body_1:
    %90 = getelementptr inbounds %SHA256_Context, %SHA256_Context* %ctx, i32 0, i32 3
    %91 = getelementptr inbounds [8 x i32], [8 x i32]* %90, i32 0, i32 0
    %92 = load i32, i32* %91
    %93 = load i32, i32* %i
    %94 = mul i32 %93, 8
    %95 = sub i32 24, %94
    ...
    %124 = getelementptr inbounds [8 x i32], [8 x i32]* %123, i32 0, i32 3
    ...
    %131 = load i32, i32* %i
    %132 = add i32 %131, 12
    %133 = getelementptr inbounds [0 x i8], [0 x i8]* %hash, i32 0, i32 %132
    store i8 %130, i8* %133
    %134 = getelementptr inbounds %SHA256_Context, %SHA256_Context* %ctx, i32 0, i32 3
    %135 = getelementptr inbounds [8 x i32], [8 x i32]* %134, i32 0, i32 4
    %136 = load i32, i32* %135
    %137 = load i32, i32* %i
    %138 = mul i32 %137, 8
    %139 = sub i32 24, %138
    %140 = lshr i32 %136, %139
    ...
    %146 = getelementptr inbounds [8 x i32], [8 x i32]* %145, i32 0, i32 5
    ...
    %153 = load i32, i32* %i
    %154 = add i32 %153, 20
    %155 = getelementptr inbounds [0 x i8], [0 x i8]* %hash, i32 0, i32 %154
    store i8 %152, i8* %155
    %156 = getelementptr inbounds %SHA256_Context, %SHA256_Context* %ctx, i32 0, i32 3
    %157 = getelementptr inbounds [8 x i32], [8 x i32]* %156, i32 0, i32 6
    ...
    %164 = load i32, i32* %i
    %165 = add i32 %164, 24
    %166 = getelementptr inbounds [0 x i8], [0 x i8]* %hash, i32 0, i32 %165
    store i8 %163, i8* %166
    %167 = getelementptr inbounds %SHA256_Context, %SHA256_Context* %ctx, i32 0, i32 3
    %168 = getelementptr inbounds [8 x i32], [8 x i32]* %167, i32 0, i32 7
    ...
    %175 = load i32, i32* %i
    %176 = add i32 %175, 28
    %177 = getelementptr inbounds [0 x i8], [0 x i8]* %hash, i32 0, i32 %176
    store i8 %174, i8* %177
    %178 = load i32, i32* %i
    %179 = add i32 %178, 1
    store i32 %179, i32* %i
