...
define i1 @sha256_doTest(%SHA256_TestCase* %test) {
	...
	%7 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([5 x i8]* @str1 to [0 x i8]*), [32 x i8]* %6)
...
body_1:
	...
	%14 = load i8, i8* %13
	%15 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([5 x i8]* @str3 to [0 x i8]*), i8 %14)
	%16 = load i32, i32* %9
	%17 = add i32 %16, 1
	store i32 %17, i32* %9
	br label %again_1
break_1:
	%18 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([2 x i8]* @str4 to [0 x i8]*))
