...
; -- strings --
; -- endstrings --
define %Int32 @min_int32(%Int32 %a, %Int32 %b) {
...
define %Int32 @max_int32(%Int32 %a, %Int32 %b) {
...
define %Int64 @min_int64(%Int64 %a, %Int64 %b) {
...
define %Int64 @max_int64(%Int64 %a, %Int64 %b) {
...
define %Int32 @min_nat32(%Int32 %a, %Int32 %b) {
...
define %Int32 @max_nat32(%Int32 %a, %Int32 %b) {
...
define %Int64 @min_nat64(%Int64 %a, %Int64 %b) {
...
define %Int64 @max_nat64(%Int64 %a, %Int64 %b) {
