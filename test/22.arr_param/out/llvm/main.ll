...
then_0:
	%17 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([15 x i8]* @str1 to [0 x i8]*))
	br label %endif_0
endif_0:
...
then_1:
	%55 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([15 x i8]* @str2 to [0 x i8]*))
	br label %endif_1
endif_1:
...
then_2:
	%74 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([15 x i8]* @str3 to [0 x i8]*))
	br label %endif_2
endif_2:
...
body_1:
	...
	%82 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([12 x i8]* @str4 to [0 x i8]*), %Int32 %78, %Int32 %81)
