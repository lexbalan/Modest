...
define %Int @main() {
	...
	%3 = getelementptr inbounds %main_Point, %main_Point* @globalPoint1, %Int32 0, %Int32 0
	%4 = load %Int32, %Int32* %3
	%5 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([21 x i8]* @str2 to [0 x i8]*), %Int32 %4)
	%6 = getelementptr inbounds %main_Point, %main_Point* @globalPoint1, %Int32 0, %Int32 1
...
endif_0:
	...
	%20 = getelementptr inbounds %main_Point, %main_Point* %18, %Int32 0, %Int32 0
	%21 = load %Int32, %Int32* %20
	%22 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([20 x i8]* @str6 to [0 x i8]*), %Int32 %21)
	%23 = getelementptr inbounds %main_Point, %main_Point* %18, %Int32 0, %Int32 1
