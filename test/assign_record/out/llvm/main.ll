...
@main_globalPoint0 = internal global %main_Point {
	%Int32 10,
	%Int32 20
}
@main_globalPoint1 = internal global %main_Point {
	%Int32 0,
	%Int32 0
}
define %Int @main() {
	%1 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([19 x i8]* @str1 to [0 x i8]*))
	%2 = load %main_Point, %main_Point* @main_globalPoint0
	store %main_Point %2, %main_Point* @main_globalPoint1
	%3 = getelementptr %main_Point, %main_Point* @main_globalPoint1, %Int32 0, %Int32 0
	%4 = load %Int32, %Int32* %3
	%5 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([21 x i8]* @str2 to [0 x i8]*), %Int32 %4)
	%6 = getelementptr %main_Point, %main_Point* @main_globalPoint1, %Int32 0, %Int32 1
	%7 = load %Int32, %Int32* %6
	%8 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([21 x i8]* @str3 to [0 x i8]*), %Int32 %7)
	%9 = bitcast %main_Point* @main_globalPoint0 to i8*
	%10 = bitcast %main_Point* @main_globalPoint1 to i8*
...
endif_0:
	...
	; local
	%15 = alloca %main_Point, align 8
	%16 = insertvalue %main_Point zeroinitializer, %Int32 10, 0
	%17 = insertvalue %main_Point %16, %Int32 20, 1
	store %main_Point %17, %main_Point* %15
	%18 = alloca %main_Point, align 8
	store %main_Point zeroinitializer, %main_Point* %18
	%19 = load %main_Point, %main_Point* %15
	store %main_Point %19, %main_Point* %18
	%20 = getelementptr %main_Point, %main_Point* %18, %Int32 0, %Int32 0
	%21 = load %Int32, %Int32* %20
	%22 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([20 x i8]* @str6 to [0 x i8]*), %Int32 %21)
	%23 = getelementptr %main_Point, %main_Point* %18, %Int32 0, %Int32 1
