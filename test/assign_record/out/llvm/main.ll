...
define %ctypes64_Int @main() {
	...
	%5 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([21 x i8]* @str2 to [0 x i8]*), %Int32 %4)
	%6 = getelementptr %Point, %Point* @globalPoint1, %Int32 0, %Int32 1
	%7 = load %Int32, %Int32* %6
	%8 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([21 x i8]* @str3 to [0 x i8]*), %Int32 %7)
...
then_0:
	%13 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([25 x i8]* @str4 to [0 x i8]*))
	br label %endif_0
else_0:
	%14 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([25 x i8]* @str5 to [0 x i8]*))
	br label %endif_0
endif_0:
	...
	%25 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([20 x i8]* @str7 to [0 x i8]*), %Int32 %24)
...
then_1:
	%30 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([24 x i8]* @str8 to [0 x i8]*))
	br label %endif_1
else_1:
	%31 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([24 x i8]* @str9 to [0 x i8]*))
	br label %endif_1
endif_1:
	ret %ctypes64_Int 0
}
