...
@str1 = private constant [29 x i8] [i8 83, i8 45, i8 116, i8 45, i8 114, i8 45, i8 105, i8 45, i8 110, i8 45, i8 103, i8 45, i8 206, i8 169, i8 32, i8 240, i8 159, i8 144, i8 128, i8 240, i8 159, i8 142, i8 137, i8 240, i8 159, i8 166, i8 132, i8 10, i8 0]
@str2 = private constant [22 x i16] [i16 83, i16 45, i16 116, i16 45, i16 114, i16 45, i16 105, i16 45, i16 110, i16 45, i16 103, i16 45, i16 937, i16 32, i16 55357, i16 56320, i16 55356, i16 57225, i16 55358, i16 56708, i16 10, i16 0]
@str3 = private constant [19 x i32] [i32 83, i32 45, i32 116, i32 45, i32 114, i32 45, i32 105, i32 45, i32 110, i32 45, i32 103, i32 45, i32 937, i32 32, i32 128000, i32 127881, i32 129412, i32 10, i32 0]
...
body_1:
    %1 = load i32, i32* %i
    %2 = getelementptr inbounds [0 x i16], [0 x i16]* bitcast ([22 x i16]* @str2 to [0 x i16]*), i32 0, i32 %1
    %3 = load i16, i16* %2
    %4 = icmp eq i16 %3, 0
