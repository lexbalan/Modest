...
define void @sumsub64(i64 %a, i64 %b) {
	...
	store i64 %5, i64* %2
	%6 = load i64, i64* %1
	%7 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([21 x i8]* @str1 to [0 x i8]*), i64 %6)
	%8 = load i64, i64* %2
	%9 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([21 x i8]* @str2 to [0 x i8]*), i64 %8)
	ret void
}

define i32 @main() {
	%1 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([17 x i8]* @str3 to [0 x i8]*))
	%2 = alloca i64, align 8
	store i64 10, i64* %2
	...
	%10 = load i64, i64* %2
	%11 = load i64, i64* %3
	%12 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([24 x i8]* @str4 to [0 x i8]*), i64 %10, i64 %11, i64 %6)
	%13 = load i64, i64* %2
	%14 = load i64, i64* %3
	%15 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([24 x i8]* @str5 to [0 x i8]*), i64 %13, i64 %14, i64 %9)
	%16 = load i64, i64* %2
	%17 = load i64, i64* %3
