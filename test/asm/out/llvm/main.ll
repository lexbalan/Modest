...
define internal void @sumsub64(%Int64 %a, %Int64 %b) {
	...
	%7 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([21 x i8]* @str1 to [0 x i8]*), %Int64 %6)
	%8 = load %Int64, %Int64* %2
	%9 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([21 x i8]* @str2 to [0 x i8]*), %Int64 %8)
	ret void
}

define %ctypes64_Int @main() {
	%1 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([17 x i8]* @str3 to [0 x i8]*))
	%2 = alloca %Int64, align 8
	...
	%12 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([24 x i8]* @str4 to [0 x i8]*), %Int64 %10, %Int64 %11, %Int64 %6)
	%13 = load %Int64, %Int64* %2
	%14 = load %Int64, %Int64* %3
	%15 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([24 x i8]* @str5 to [0 x i8]*), %Int64 %13, %Int64 %14, %Int64 %9)
