...
define %Int32 @main() {
	...
	%11 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([12 x i8]* @str1 to [0 x i8]*), %Int64 %10)
	...
	%15 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([12 x i8]* @str2 to [0 x i8]*), %Int64 %14)
	ret %Int32 0
}
