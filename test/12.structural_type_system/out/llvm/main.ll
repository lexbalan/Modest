...
define internal void @main_f1_ptr(%main_Type2* %x) {
...
define internal void @main_f2_ptr(%main_Type3* %x) {
...
define internal void @main_f3_ptr({%Int32}* %x) {
...
define internal void @main_test_by_value() {
	...
	call void @main_f0_val(%main_Type1 %1)
...
; -- end cons_composite_from_composite_by_adr --
	call void @main_f1_val(%main_Type2 %3)
; -- cons_composite_from_composite_by_adr --
	%4 = bitcast %main_Type1* @main_a to %main_Type3*
	%5 = load %main_Type3, %main_Type3* %4
; -- end cons_composite_from_composite_by_adr --
	call void @main_f2_val(%main_Type3 %5)
; -- cons_composite_from_composite_by_adr --
	%6 = bitcast %main_Type1* @main_a to {%Int32}*
	%7 = load {%Int32}, {%Int32}* %6
; -- end cons_composite_from_composite_by_adr --
	call void @main_f3_val({%Int32} %7)
; -- cons_composite_from_composite_by_adr --
	%8 = bitcast %main_Type2* @main_b to %main_Type1*
	%9 = load %main_Type1, %main_Type1* %8
; -- end cons_composite_from_composite_by_adr --
	call void @main_f0_val(%main_Type1 %9)
	%10 = load %main_Type2, %main_Type2* @main_b
	call void @main_f1_val(%main_Type2 %10)
; -- cons_composite_from_composite_by_adr --
	%11 = bitcast %main_Type2* @main_b to %main_Type3*
	%12 = load %main_Type3, %main_Type3* %11
; -- end cons_composite_from_composite_by_adr --
	call void @main_f2_val(%main_Type3 %12)
; -- cons_composite_from_composite_by_adr --
	%13 = bitcast %main_Type2* @main_b to {%Int32}*
	%14 = load {%Int32}, {%Int32}* %13
; -- end cons_composite_from_composite_by_adr --
	call void @main_f3_val({%Int32} %14)
; -- cons_composite_from_composite_by_adr --
	%15 = bitcast %main_Type3* @main_c to %main_Type1*
	%16 = load %main_Type1, %main_Type1* %15
; -- end cons_composite_from_composite_by_adr --
	call void @main_f0_val(%main_Type1 %16)
; -- cons_composite_from_composite_by_adr --
	%17 = bitcast %main_Type3* @main_c to %main_Type2*
	%18 = load %main_Type2, %main_Type2* %17
; -- end cons_composite_from_composite_by_adr --
	call void @main_f1_val(%main_Type2 %18)
	%19 = load %main_Type3, %main_Type3* @main_c
	call void @main_f2_val(%main_Type3 %19)
; -- cons_composite_from_composite_by_adr --
	%20 = bitcast %main_Type3* @main_c to {%Int32}*
	%21 = load {%Int32}, {%Int32}* %20
; -- end cons_composite_from_composite_by_adr --
	call void @main_f3_val({%Int32} %21)
	ret void
}

define internal void @main_test_by_pointer() {
	call void @main_f0_ptr(%main_Type1* @main_a)
	call void @main_f1_ptr(%main_Type2* bitcast (%main_Type1* @main_a to %main_Type2*))
	call void @main_f2_ptr(%main_Type3* bitcast (%main_Type1* @main_a to %main_Type3*))
	call void @main_f3_ptr({%Int32}* bitcast (%main_Type1* @main_a to {%Int32}*))
	call void @main_f0_ptr(%main_Type1* bitcast (%main_Type2* @main_b to %main_Type1*))
	call void @main_f1_ptr(%main_Type2* @main_b)
	call void @main_f2_ptr(%main_Type3* bitcast (%main_Type2* @main_b to %main_Type3*))
	call void @main_f3_ptr({%Int32}* bitcast (%main_Type2* @main_b to {%Int32}*))
	call void @main_f0_ptr(%main_Type1* bitcast (%main_Type3* @main_c to %main_Type1*))
	call void @main_f1_ptr(%main_Type2* bitcast (%main_Type3* @main_c to %main_Type2*))
	call void @main_f2_ptr(%main_Type3* @main_c)
	call void @main_f3_ptr({%Int32}* bitcast (%main_Type3* @main_c to {%Int32}*))
	ret void
}
