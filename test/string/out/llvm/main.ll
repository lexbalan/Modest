...
define %ctypes64_Int @main() {
	...
	%1 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([2 x i8]* @str4 to [0 x i8]*))
	call void @console_putchar_utf16(%Char16 937)
	%2 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([2 x i8]* @str5 to [0 x i8]*))
	call void @console_putchar_utf32(%Char32 129412)
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([3 x i8]* @str6 to [0 x i8]*))
	call void @console_puts8(%Str8* bitcast ([6 x %Char8]* @string8 to %Str8*))
	%4 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([2 x i8]* @str7 to [0 x i8]*))
	call void @console_puts16(%Str16* bitcast ([8 x %Char16]* @string16 to %Str16*))
	%5 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([2 x i8]* @str8 to [0 x i8]*))
	call void @console_puts32(%Str32* bitcast ([12 x %Char32]* @string32 to %Str32*))
	%6 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([3 x i8]* @str9 to [0 x i8]*))
	%7 = load [0 x %Char8]*, [0 x %Char8]** @ptr_to_string8
	call void @console_puts8([0 x %Char8]* %7)
	%8 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([2 x i8]* @str10 to [0 x i8]*))
	%9 = load [0 x %Char16]*, [0 x %Char16]** @ptr_to_string16
	call void @console_puts16([0 x %Char16]* %9)
	%10 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([2 x i8]* @str11 to [0 x i8]*))
	%11 = load [0 x %Char32]*, [0 x %Char32]** @ptr_to_string32
	call void @console_puts32([0 x %Char32]* %11)
	%12 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([2 x i8]* @str12 to [0 x i8]*))
	ret %ctypes64_Int 0
}
