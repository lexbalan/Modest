...
body_1:
	...
	%9 = load i32, i32* %8
	%10 = load i32, i32* %4
	%11 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([23 x i8]* @str2 to [0 x i8]*), i32 %10, i32 %9)
	%12 = load i32, i32* %4
	%13 = add i32 %12, 1
	store i32 %13, i32* %4
	br label %again_1
...
then_0:
	%18 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([25 x i8]* @str3 to [0 x i8]*))
	br label %endif_0
else_0:
	%19 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([25 x i8]* @str4 to [0 x i8]*))
	br label %endif_0
endif_0:
	; local
...
body_2:
	...
	%48 = load i32, i32* %47
	%49 = load i32, i32* %4
	%50 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([22 x i8]* @str5 to [0 x i8]*), i32 %49, i32 %48)
	%51 = load i32, i32* %4
	%52 = add i32 %51, 1
	store i32 %52, i32* %4
	br label %again_2
...
then_1:
	%57 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([24 x i8]* @str6 to [0 x i8]*))
	br label %endif_1
else_1:
	%58 = call i32 (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([24 x i8]* @str7 to [0 x i8]*))
	br label %endif_1
endif_1:
	ret i32 0
}
