...
define i32 @main() {
    ...
    %2 = load i32, i32* %c
    %3 = call i32(%ConstCharStr*, ...) @printf (%ConstCharStr* bitcast ([16 x i8]* @str2 to [0 x i8]*), i32 %2)
    store i32 1, i32* %c
    %4 = load i32, i32* %c
    %5 = call i32(%ConstCharStr*, ...) @printf (%ConstCharStr* bitcast ([25 x i8]* @str3 to [0 x i8]*), i32 %4)
    ret i32 0
}
