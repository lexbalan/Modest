...
define %ctypes64_Int @main() {
	...
	store %Word32 2147483648, %Word32* %2
	%3 = load %Word32, %Word32* %2
	%4 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([16 x i8]* @str2 to [0 x i8]*), %Word32 %3)
	store %Word32 1, %Word32* %2
	%5 = load %Word32, %Word32* %2
	%6 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([25 x i8]* @str3 to [0 x i8]*), %Word32 %5)
	ret %ctypes64_Int 0
}
