...
;	printf("x0 = %llx\n", y0)
;	printf("x1 = %llx\n", y1)
	%2 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([8 x i8]* @str2 to [0 x i8]*), %Int8 255)
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([8 x i8]* @str3 to [0 x i8]*), %Int32 255)
