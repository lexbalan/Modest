...
body_1:
    ...
    call void (i8*, i8*, i32, i1) @llvm.memcpy.p0.p0.i32(i8* %7, i8* %8, i32 1, i1 0)
    %9 = load i8, i8* %4
    %10 = icmp eq i8 %9, 0
...
then_1:
    ...
    store i32 %15, i32* %3
    %16 = load i32, i32* %3
    %17 = getelementptr inbounds %Str8, %Str8* %str, i32 0, i32 %16
    %18 = bitcast i8* %4 to i8*
    %19 = bitcast i8* %17 to i8*
    call void (i8*, i8*, i32, i1) @llvm.memcpy.p0.p0.i32(i8* %18, i8* %19, i32 1, i1 0)
...
body_2:
    ...
    call void (i8*, i8*, i32, i1) @llvm.memcpy.p0.p0.i32(i8* %26, i8* %27, i32 1, i1 0)
    %28 = load i32, i32* %17
    %29 = add i32 %28, 1
    store i32 %29, i32* %17
    br label %again_2
...
body_2:
    ...
    call void (i8*, i8*, i32, i1) @llvm.memcpy.p0.p0.i32(i8* %33, i8* %34, i32 1, i1 0)
    %35 = load i32, i32* %21
    %36 = add i32 %35, 1
    store i32 %36, i32* %21
    br label %again_2
