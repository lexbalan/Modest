...
define internal %ctypes64_SSizeT @my_printf(%Str8* %format, ...) {
	%1 = alloca i8*, align 1
	%2 = alloca i8*, align 1
	...
	%7 = bitcast [128 x %Char8]* %6 to %stdio_CharStr*
	%8 = load i8*, i8** %2
	%9 = call %ctypes64_Int @vsnprintf(%stdio_CharStr* %7, %ctypes64_SizeT 128, %Str8* %format, i8* %8)
	%10 = bitcast i8** %2 to i8*
	call void @llvm.va_end(i8* %10)
	%11 = bitcast [128 x %Char8]* %6 to i8*
	%12 = zext %ctypes64_Int %9 to %ctypes64_SizeT
	%13 = call %ctypes64_SSizeT @write(%ctypes64_Int 1, i8* %11, %ctypes64_SizeT %12)
	ret %ctypes64_SSizeT %13
}
...
define %ctypes64_Int @main() {
	...
	%3 = call %ctypes64_SSizeT (%Str8*, ...) @my_printf(%Str8* bitcast ([19 x i8]* @str1 to [0 x i8]*), %Int32 %2)
	%4 = call %ctypes64_SSizeT (%Str8*, ...) @my_printf(%Str8* bitcast ([4 x i8]* @str3 to [0 x i8]*))
	%5 = call %ctypes64_SSizeT (%Str8*, ...) @my_printf(%Str8* bitcast ([10 x i8]* @str4 to [0 x i8]*), %Char8 36)
	%6 = call %ctypes64_SSizeT (%Str8*, ...) @my_printf(%Str8* bitcast ([10 x i8]* @str5 to [0 x i8]*), %Str8* bitcast ([4 x i8]* @str2 to [0 x i8]*))
	%7 = call %ctypes64_SSizeT (%Str8*, ...) @my_printf(%Str8* bitcast ([8 x i8]* @str6 to [0 x i8]*), %Int32 -1)
	%8 = call %ctypes64_SSizeT (%Str8*, ...) @my_printf(%Str8* bitcast ([8 x i8]* @str7 to [0 x i8]*), %Int32 123)
	%9 = call %ctypes64_SSizeT (%Str8*, ...) @my_printf(%Str8* bitcast ([10 x i8]* @str8 to [0 x i8]*), %Int32 305419903)
	ret %ctypes64_Int 0
}
