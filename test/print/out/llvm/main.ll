...
; -- end print imports --
; -- strings --
@str1 = private constant [5 x i8] [i8 123, i8 115, i8 125, i8 10, i8 0]
...
@str4 = private constant [2 x i8] [i8 92, i8 0]
...
define %Int @main() {
	call void (%Str8*, ...) @console_print(%Str8* bitcast ([5 x i8]* @str1 to [0 x i8]*), %Str8* bitcast ([13 x i8]* @str2 to [0 x i8]*))
	...
	call void (%Str8*, ...) @console_print(%Str8* bitcast ([11 x i8]* @str6 to [0 x i8]*), i8 36)
	call void (%Str8*, ...) @console_print(%Str8* bitcast ([11 x i8]* @str7 to [0 x i8]*), %Str8* bitcast ([4 x i8]* @str3 to [0 x i8]*))
