...
endif_1:
	%46 = load i8, i8* %3
	%47 = icmp ne i8 %46, 123
	br i1 %47 , label %then_5, label %endif_5
then_5:
	%48 = load i32, i32* %2
	%49 = getelementptr inbounds [0 x i8], [0 x i8]* %buf, i32 0, i32 %48
	%50 = load i8, i8* %3
	store i8 %50, i8* %49
	%51 = load i32, i32* %2
	%52 = add i32 %51, 1
...
endif_5:
	...
	store i32 %57, i32* %1
	%58 = load i32, i32* %1
	%59 = getelementptr inbounds %Str8, %Str8* %form, i32 0, i32 %58
	%60 = load i8, i8* %59
	store i8 %60, i8* %3
	%61 = load i32, i32* %1
	%62 = add i32 %61, 2
	store i32 %62, i32* %1
	%63 = load i32, i32* %2
	%64 = getelementptr inbounds [0 x i8], [0 x i8]* %buf, i32 0, i32 %63
;
	%65 = bitcast i8* %64 to [0 x i8]*
	%66 = load i8, i8* %3
...
then_6:
	...
	;
	%71 = va_arg i8* %va, i32
	%72 = call i32 @sprint_dec_int32([0 x i8]* %65, i32 %71)
	%73 = load i32, i32* %2
	%74 = add i32 %73, %72
	store i32 %74, i32* %2
	br label %endif_6
...
then_7:
	...
	;
	%77 = va_arg i8* %va, i32
	%78 = call i32 @sprint_n32([0 x i8]* %65, i32 %77)
	%79 = load i32, i32* %2
	%80 = add i32 %79, %78
	store i32 %80, i32* %2
	br label %endif_7
else_7:
	...
	%85 = or i1 %82, %84
	br i1 %85 , label %then_8, label %else_8
then_8:
	;
	...
	;
	%86 = va_arg i8* %va, i32
	%87 = call i32 @sprint_hex_nat32([0 x i8]* %65, i32 %86)
	%88 = load i32, i32* %2
	%89 = add i32 %88, %87
	store i32 %89, i32* %2
	br label %endif_8
else_8:
	...
	br i1 %91 , label %then_9, label %else_9
then_9:
	;
	; %s pointer to string
	;
	%92 = va_arg i8* %va, %Str8*
	%93 = call [0 x %Char]* @strcpy([0 x i8]* %65, %Str8* %92)
	%94 = load i32, i32* %2
	%95 = call %SizeT @strlen(%Str8* %92)
	%96 = trunc %SizeT %95 to i32
	%97 = add i32 %94, %96
	store i32 %97, i32* %2
	br label %endif_9
else_9:
	%98 = load i8, i8* %3
	%99 = icmp eq i8 %98, 99
	br i1 %99 , label %then_10, label %endif_10
then_10:
	;
	; %c for char
	;
	%100 = va_arg i8* %va, i32
	%101 = bitcast [0 x i8]* %65 to [4 x i8]*
	%102 = call i8 @utf_utf32_to_utf8(i32 %100, [4 x i8]* %101)
