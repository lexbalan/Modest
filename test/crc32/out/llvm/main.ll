...
define %ctypes64_Int @main() {
	...
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([27 x i8]* @str2 to [0 x i8]*), %Str8* bitcast ([10 x i8]* @str3 to [0 x i8]*), %Word32 %2)
	%4 = icmp eq %Word32 %2, 3421780262
	br %Bool %4 , label %then_0, label %else_0
then_0:
	%5 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([13 x i8]* @str4 to [0 x i8]*))
	br label %endif_0
else_0:
	%6 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([13 x i8]* @str5 to [0 x i8]*))
	br label %endif_0
endif_0:
	ret %ctypes64_Int 0
}
