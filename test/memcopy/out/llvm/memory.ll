...
body_1:
	...
	%8 = getelementptr inbounds [0 x %Word8], [0 x %Word8]* %3, %Int32 0, %Int64 %7
...
body_2:
	...
	%19 = getelementptr inbounds [0 x %Word], [0 x %Word]* %15, %Int32 0, %Int64 %18
...
body_3:
	...
	%30 = getelementptr inbounds [0 x %Word8], [0 x %Word8]* %26, %Int32 0, %Int64 %29
...
body_1:
	%7 = load %Int64, %Int64* %4
	%8 = getelementptr inbounds [0 x %Word], [0 x %Word]* %3, %Int32 0, %Int64 %7
	%9 = load %Int64, %Int64* %4
	%10 = getelementptr inbounds [0 x %Word], [0 x %Word]* %2, %Int32 0, %Int64 %9
...
break_1:
	...
	%16 = getelementptr inbounds [0 x %Word], [0 x %Word]* %2, %Int32 0, %Int64 %15
	%17 = bitcast %Word* %16 to [0 x %Word8]*
	%18 = load %Int64, %Int64* %4
	%19 = getelementptr inbounds [0 x %Word], [0 x %Word]* %3, %Int32 0, %Int64 %18
...
body_2:
	...
	%24 = getelementptr inbounds [0 x %Word8], [0 x %Word8]* %20, %Int32 0, %Int64 %23
	%25 = load %Int64, %Int64* %4
	%26 = getelementptr inbounds [0 x %Word8], [0 x %Word8]* %17, %Int32 0, %Int64 %25
...
break_1:
	%17 = urem %Int64 %len, 8
	%18 = load %Int64, %Int64* %4
	%19 = getelementptr inbounds [0 x %Word], [0 x %Word]* %2, %Int32 0, %Int64 %18
	%20 = bitcast %Word* %19 to [0 x %Word8]*
	%21 = load %Int64, %Int64* %4
	%22 = getelementptr inbounds [0 x %Word], [0 x %Word]* %3, %Int32 0, %Int64 %21
