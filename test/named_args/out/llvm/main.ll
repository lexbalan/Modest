...
; -- strings --
@str1 = private constant [17 x i8] [i8 116, i8 101, i8 115, i8 116, i8 32, i8 110, i8 97, i8 109, i8 101, i8 100, i8 95, i8 97, i8 114, i8 103, i8 115, i8 10, i8 0]
...
define %ctypes64_Int @main() {
	%1 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([17 x i8]* @str1 to [0 x i8]*))
	%2 = call %Int32 @named_args_test(%Int32 25, %Int32 15, %Int32 3)
	%3 = icmp eq %Int32 30, %2
	br %Bool %3 , label %then_0, label %else_0
then_0:
	%4 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([13 x i8]* @str2 to [0 x i8]*))
	br label %endif_0
else_0:
	%5 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([13 x i8]* @str3 to [0 x i8]*))
	br label %endif_0
endif_0:
	ret %ctypes64_Int 0
}
