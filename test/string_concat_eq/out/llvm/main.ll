...
; -- endstrings --;+ " " + party_corn
define %ctypes64_Int @main() {
	%1 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([4 x i8]* @str1 to [0 x i8]*), %Str8* bitcast ([12 x i8]* @str2 to [0 x i8]*))
	br %Bool 1 , label %then_0, label %else_0
then_0:
	%2 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([10 x i8]* @str3 to [0 x i8]*))
	br label %endif_0
else_0:
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([14 x i8]* @str4 to [0 x i8]*))
	br label %endif_0
endif_0:
	ret %ctypes64_Int 0
}
