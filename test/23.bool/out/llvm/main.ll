...
define %ctypes64_Int @main() {
	...
	%8 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([8 x i8]* @str2 to [0 x i8]*), %Int32 %7)
	%9 = load %Bool, %Bool* %3
	%10 = zext %Bool %9 to %Int32
	%11 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([16 x i8]* @str3 to [0 x i8]*), %Int32 %10)
	store %Int8 2, %Int8* %2
	;b = Bool x
	%12 = load %Int8, %Int8* %2
	...
	%16 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([8 x i8]* @str4 to [0 x i8]*), %Int32 %15)
	%17 = load %Bool, %Bool* %3
	%18 = zext %Bool %17 to %Int32
	%19 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([16 x i8]* @str5 to [0 x i8]*), %Int32 %18)
	store %Int8 3, %Int8* %2
	;b = Bool x
	%20 = load %Int8, %Int8* %2
	...
	%24 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([8 x i8]* @str6 to [0 x i8]*), %Int32 %23)
	%25 = load %Bool, %Bool* %3
	%26 = zext %Bool %25 to %Int32
	%27 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([16 x i8]* @str7 to [0 x i8]*), %Int32 %26)
	ret %ctypes64_Int 0
}
