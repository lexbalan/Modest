...
define %ctypes64_Int @main() {
	...
	%2 = call %ctypes64_PIDT @getpid()
	%3 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([10 x i8]* @str2 to [0 x i8]*), %ctypes64_PIDT %2)
	%4 = call %ctypes64_Long @gethostid()
	%5 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([14 x i8]* @str3 to [0 x i8]*), %ctypes64_Long %4)

	; current control terminal
	%6 = alloca [128 x %Char8], align 1
	%7 = bitcast [128 x %Char8]* %6 to [0 x %ctypes64_Char]*
	%8 = call [0 x %ctypes64_Char]* @ctermid([0 x %ctypes64_Char]* %7)
	%9 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([14 x i8]* @str4 to [0 x i8]*), [128 x %Char8]* %6)

	; current working directory
	%10 = alloca [128 x %Char8], align 1
	%11 = bitcast [128 x %Char8]* %10 to [0 x %ctypes64_Char]*
	%12 = call [0 x %ctypes64_Char]* @getcwd([0 x %ctypes64_Char]* %11, %ctypes64_SizeT 128)
	%13 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([10 x i8]* @str5 to [0 x i8]*), [128 x %Char8]* %10)
	%14 = call [0 x %ctypes64_Char]* @ttyname(%ctypes64_Int 0)
	%15 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([14 x i8]* @str6 to [0 x i8]*), [0 x %ctypes64_Char]* %14)
	%16 = call %ctypes64_Str* @getenv(%ctypes64_Str* bitcast ([5 x i8]* @str7 to [0 x i8]*))
	%17 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([11 x i8]* @str8 to [0 x i8]*), %ctypes64_Str* %16)
	br label %again_1
again_1:
	br %Bool 1 , label %body_1, label %break_1
body_1:
	%18 = call %ctypes64_Int (%stdio_ConstCharStr*, ...) @printf(%stdio_ConstCharStr* bitcast ([6 x i8]* @str9 to [0 x i8]*))
	%19 = call %ctypes64_UnsignedInt @sleep(%ctypes64_UnsignedInt 1)
	br label %again_1
break_1:
	ret %ctypes64_Int 0
}
