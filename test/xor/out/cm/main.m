...
func xor_encrypter(buf: *[/*U*/]Word8, buflen: Nat32, key: *[/*U*/]Word8, keylen: Nat32) -> Unit {
	var i: Nat32 = Nat32 0
	var j: Nat32 = Nat32 0
	while i < buflen {
...
func print_bytes(buf: *[/*U*/]Word8, len: Nat32) -> Unit {
	var i: Nat32 = Nat32 0
	while i < len {
		printf("0x%02X ", buf[i])
		i = i + 1
...
public func main() -> Int {
	...
	let tmsg = *[/*U*/]Word8 &test_msg
	let tkey = *[/*U*/]Word8 &test_key
