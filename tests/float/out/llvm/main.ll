...
define internal %Float32 @slope(%Point2D %a, %Point2D %b) {
...
define %Int @main() {
	...
	%3 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([10 x i8]* @str5 to [0 x i8]*), %Float64 0.0000000000000000)
	...
	%6 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([8 x i8]* @str7 to [0 x i8]*), %Float64 0.0000000000000000)
