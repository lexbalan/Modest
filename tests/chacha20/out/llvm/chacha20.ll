...
define void @chacha20_makeState(%chacha20_State* %0, %chacha20_Key* %key, %Word32 %counter, [3 x %Word32]* %nonce) {
	%2 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 0
	%3 = load %Word32, %Word32* %2
	%4 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 1
	%5 = load %Word32, %Word32* %4
	%6 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 2
	%7 = load %Word32, %Word32* %6
	%8 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 3
	%9 = load %Word32, %Word32* %8
	%10 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 4
	%11 = load %Word32, %Word32* %10
	%12 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 5
	%13 = load %Word32, %Word32* %12
	%14 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 6
	%15 = load %Word32, %Word32* %14
	%16 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 7
	...
	%28 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 0
	%29 = load %Word32, %Word32* %28
	%30 = insertvalue [16 x %Word32] %27, %Word32 %29, 4
	%31 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 1
	%32 = load %Word32, %Word32* %31
	%33 = insertvalue [16 x %Word32] %30, %Word32 %32, 5
	%34 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 2
	%35 = load %Word32, %Word32* %34
	%36 = insertvalue [16 x %Word32] %33, %Word32 %35, 6
	%37 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 3
	%38 = load %Word32, %Word32* %37
	%39 = insertvalue [16 x %Word32] %36, %Word32 %38, 7
	%40 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 4
	%41 = load %Word32, %Word32* %40
	%42 = insertvalue [16 x %Word32] %39, %Word32 %41, 8
	%43 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 5
	%44 = load %Word32, %Word32* %43
	%45 = insertvalue [16 x %Word32] %42, %Word32 %44, 9
	%46 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 6
	%47 = load %Word32, %Word32* %46
	%48 = insertvalue [16 x %Word32] %45, %Word32 %47, 10
	%49 = getelementptr %chacha20_Key, %chacha20_Key* %key, %Int32 0, %Int32 7
...
; -- cons_composite_from_composite_by_value --
	...
	%64 = bitcast [16 x %Word32]* %62 to %chacha20_State*
; -- end cons_composite_from_composite_by_value --
	%65 = load %chacha20_State, %chacha20_State* %64
	%66 = zext i8 16 to %Nat32
	store %chacha20_State %65, %chacha20_State* %0
	ret void
}
