...
static void cipher(struct context *ctx, uint8_t (*data)[], uint32_t len) {
	...
	while (i < len) {
		if (ctx->blockOffset == /*$*/((uint32_t)sizeof(chacha20_Block))) {
			...
			memcpy(/*K*/((uint32_t (*)[16 - 13])&state[13]), /*K*/((uint32_t (*)[3 - 0])&ctx->nonce[0]), sizeof(uint32_t [16 - 13]));
...
static const uint8_t testResult[64] = {0x10, 0xF1, 0xE7, 0xE4, 0xD1, 0x3B, 0x59, 0x15, 0x50, 0xF, 0xDD, 0x1F, 0xA3, 0x20, 0x71, 0xC4, 0xC7, 0xD1, 0xF4, 0xC7, 0x33, 0xC0, 0x68, 0x3, 0x4, 0x22, 0xAA, 0x9A, 0xC3, 0xD4, 0x6C, 0x4E, 0xD2, 0x82, 0x64, 0x46, 0x7, 0x9F, 0xAA, 0x9, 0x14, 0xC2, 0xD7, 0x5, 0xD9, 0x8B, 0x2, 0xA2, 0xB5, 0x12, 0x9C, 0xD1, 0xDE, 0x16, 0x4E, 0xB9, 0xCB, 0xD0, 0x83, 0xE8, 0xA2, 0x50, 0x3C, 0x4E};
static const char lorem1024[1024] = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit ve";
...
static bool test0(void) {
	uint8_t key[32];
	memcpy(/*K*/(&key), /*K*/(&testKey), sizeof(uint8_t [32]));
	uint32_t counter = 0x1;
	uint8_t nonce[12];
	memcpy(/*K*/(&nonce), /*K*/(&testNonce), sizeof(uint8_t [12]));
	chacha20_State state;
