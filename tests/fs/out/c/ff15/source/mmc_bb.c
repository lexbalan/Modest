...
#define	INIT_PORT()	/* Initialize MMC control port (CS=H, CLK=L, DI=H, DO=pu) */
#define DLY_US(n)	delay_us(n)	/* Delay n microseconds */
#define DLY_MS(n)	delay_us(n)	/* Delay n miliseconds */

#define	CS_H()	nospi_cs(1)	    /* Set MMC_CS "high" */
#define CS_L()	nospi_cs(0)	    /* Set MMC_CS "low" */
#define CK_H()	nospi_clk(1)	/* Set MMC_SCLK "high" */
#define	CK_L()	nospi_clk(0)	/* Set MMC_SCLK "low" */
#define DI_H()	nospi_dout(1)	/* Set MMC_DI "high" */
#define DI_L()	nospi_dout(0)	/* Set MMC_DI "low" */
#define DO()	nospi_din()	    /* Test for MMC_DO ('H':true, 'L':false) */
