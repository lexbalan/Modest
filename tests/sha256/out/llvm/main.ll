...
body_1:
	...
	%8 = getelementptr [2 x %main_SHA256_TestCase*], [2 x %main_SHA256_TestCase*]* @main_tests, %Int32 0, %Nat32 %7
	%9 = load %main_SHA256_TestCase*, %main_SHA256_TestCase** %8
	%10 = call %Bool @main_doTest(%main_SHA256_TestCase* %9)
	%11 = load %Bool, %Bool* %2
	%12 = and %Bool %11, %10
