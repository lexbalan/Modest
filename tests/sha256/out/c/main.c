...
static struct sha256_test_case test0 = /*mark=CR2*/{
	.inputData = /*mark=CA3*/"abc",
	.inputDataLen = 3,
	.expectedResult = /*mark=CA4*/{0xBA, 0x78, 0x16, 0xBF, 0x8F, 0x1, 0xCF, 0xEA, 0x41, 0x41, 0x40, 0xDE, 0x5D, 0xAE, 0x22, 0x23, 0xB0, 0x3, 0x61, 0xA3, 0x96, 0x17, 0x7A, 0x9C, 0xB4, 0x10, 0xFF, 0x61, 0xF2, 0x0, 0x15, 0xAD}
};

static struct sha256_test_case test1 = /*mark=CR2*/{
	.inputData = /*mark=CA3*/"Hello World!",
	.inputDataLen = 12,
	.expectedResult = /*mark=CA4*/{0x7F, 0x83, 0xB1, 0x65, 0x7F, 0xF1, 0xFC, 0x53, 0xB9, 0x2D, 0xC1, 0x81, 0x48, 0xA1, 0xD6, 0x5D, 0xFC, 0x2D, 0x4B, 0x1F, 0xA3, 0xD6, 0x77, 0x28, 0x4A, 0xDD, 0xD2, 0x0, 0x12, 0x6D, 0x90, 0x69}
};
