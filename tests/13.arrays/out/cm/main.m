...
func f0(x: [<str_value>]Char8) -> [<str_value>]Char8 {
	...
	// truncate array
	var mic: [<str_value>]Char8 = [<str_value>]Char8 x
	mic[5] = "\x0"

	stdio.("f0 mic = \"%s\"\n", &mic)

	// extend array
	var res: [<str_value>]Char8 = [<str_value>]Char8 x
	res[6] = "M"
	res[7] = "o"
	res[8] = "d"
	res[9] = "e"
...
public func main() -> Int {
	...
	var d: [<str_value>]Int32 = [<str_value>]Int32 c
	stdio.("d[0] = %i\n", d[0])
	stdio.("d[1] = %i\n", d[1])
	stdio.("d[2] = %i\n", d[2])
	stdio.("d[3] = %i\n", d[3])
	...
	stdio.("y[%i] = %i (must be 10)\n", Int32 0, y[0])
	stdio.("y[%i] = %i (must be 20)\n", Int32 1, y[1])
	stdio.("y[%i] = %i (must be 30)\n", Int32 2, y[2])
	stdio.("y[%i] = %i (must be 40)\n", Int32 3, y[3])
