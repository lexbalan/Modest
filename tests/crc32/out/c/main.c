...
static struct test tests[3] = {{.data = "123456789", .len = 9, .hash = 3421780262}, {.data = "The quick brown fox jumps over the lazy dog", .len = 43, .hash = 1095738169}, {.data = "Test vector from febooti.com", .len = 28, .hash = 210206561}};
