...
define void @byteQueue_init(%byteQueue_QueueWord8* %q, [0 x %Word8]* %buf, %Nat32 %capacity) {
	%1 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 0
	%2 = bitcast %queue_Queue* %1 to %queue_Queue*
	call void @queue_init(%queue_Queue* %2, %Nat32 %capacity)
	%3 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 1
	store [0 x %Word8]* %buf, [0 x %Word8]** %3
	ret void
}

define %Nat32 @byteQueue_capacity(%byteQueue_QueueWord8* %q) {
	%1 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 0
	%2 = bitcast %queue_Queue* %1 to %queue_Queue*
...
define %Nat32 @byteQueue_size(%byteQueue_QueueWord8* %q) {
	%1 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 0
	%2 = bitcast %queue_Queue* %1 to %queue_Queue*
...
define %Bool @byteQueue_isFull(%byteQueue_QueueWord8* %q) {
	%1 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 0
	%2 = bitcast %queue_Queue* %1 to %queue_Queue*
...
define %Bool @byteQueue_isEmpty(%byteQueue_QueueWord8* %q) {
	%1 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 0
	%2 = bitcast %queue_Queue* %1 to %queue_Queue*
...
define %Bool @byteQueue_put(%byteQueue_QueueWord8* %q, %Word8 %b) {
; if_0
	%1 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 0
	%2 = bitcast %queue_Queue* %1 to %queue_Queue*
	%3 = call %Bool @queue_isFull(%queue_Queue* %2)
...
then_0:
	...
	br label %endif_0
endif_0:
	%5 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 0
	%6 = bitcast %queue_Queue* %5 to %queue_Queue*
	%7 = call %Nat32 @queue_getPutPosition(%queue_Queue* %6)
	%8 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 1
...
define %Bool @byteQueue_get(%byteQueue_QueueWord8* %q, %Word8* %b) {
; if_0
	%1 = getelementptr %byteQueue_QueueWord8, %byteQueue_QueueWord8* %q, %Int32 0, %Int32 0
	%2 = bitcast %queue_Queue* %1 to %queue_Queue*
	%3 = call %Bool @queue_isEmpty(%queue_Queue* %2)
