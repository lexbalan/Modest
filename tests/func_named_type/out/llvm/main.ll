...
; -- strings --
@.str1 = private constant [26 x i8] [i8 100, i8 105, i8 115, i8 107, i8 32, i8 102, i8 97, i8 105, i8 108, i8 101, i8 100, i8 32, i8 119, i8 105, i8 116, i8 104, i8 32, i8 99, i8 111, i8 100, i8 101, i8 32, i8 37, i8 100, i8 10, i8 0]
@.str2 = private constant [29 x i8] [i8 110, i8 101, i8 116, i8 119, i8 111, i8 114, i8 107, i8 32, i8 102, i8 97, i8 105, i8 108, i8 101, i8 100, i8 32, i8 119, i8 105, i8 116, i8 104, i8 32, i8 99, i8 111, i8 100, i8 101, i8 32, i8 37, i8 100, i8 10, i8 0]
; -- endstrings --
%FailHandler = type void (%Int32);
define internal void @onDiskFail(%Int32 %code) {
	%1 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([26 x i8]* @.str1 to [0 x i8]*), %Int32 %code)
	ret void
}

define internal void @onNetworkFail(%Int32 %code) {
	%1 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([29 x i8]* @.str2 to [0 x i8]*), %Int32 %code)
	ret void
}

define %Int @main() {
	call void @onDiskFail(%Int32 1)
	call void @onNetworkFail(%Int32 2)
	ret %Int 0
}
