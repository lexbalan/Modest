...
int main(void) {
	...
	printf(/*4*/"sizeof(Unit) = %zu\n", (/*sizeof(void)*/(size_t)0));
	printf(/*4*/"alignof(Unit) = %zu\n", (/*alignof(void)*/(size_t)1));

	printf(/*4*/"sizeof(Bool) = %zu\n", sizeof(bool));
	printf(/*4*/"alignof(Bool) = %zu\n", __alignof(bool));

	printf(/*4*/"sizeof(Nat8) = %zu\n", sizeof(uint8_t));
	printf(/*4*/"alignof(Nat8) = %zu\n", __alignof(uint8_t));
	printf(/*4*/"sizeof(Nat16) = %zu\n", sizeof(uint16_t));
	printf(/*4*/"alignof(Nat16) = %zu\n", __alignof(uint16_t));
	printf(/*4*/"sizeof(Nat32) = %zu\n", sizeof(uint32_t));
	printf(/*4*/"alignof(Nat32) = %zu\n", __alignof(uint32_t));
	printf(/*4*/"sizeof(Nat64) = %zu\n", sizeof(uint64_t));
	printf(/*4*/"alignof(Nat64) = %zu\n", __alignof(uint64_t));
	printf(/*4*/"sizeof(Nat128) = %zu\n", sizeof(unsigned __int128));
	printf(/*4*/"alignof(Nat128) = %zu\n", __alignof(unsigned __int128));
	// type Nat256 not implemented
	//printf("sizeof(Nat256) = %zu\n", sizeof(Nat256))

	printf(/*4*/"sizeof(Int8) = %zu\n", sizeof(int8_t));
	printf(/*4*/"alignof(Int8) = %zu\n", __alignof(int8_t));
	printf(/*4*/"sizeof(Int16) = %zu\n", sizeof(int16_t));
	printf(/*4*/"alignof(Int16) = %zu\n", __alignof(int16_t));
	printf(/*4*/"sizeof(Int32) = %zu\n", sizeof(int32_t));
	printf(/*4*/"alignof(Int32) = %zu\n", __alignof(int32_t));
	printf(/*4*/"sizeof(Int64) = %zu\n", sizeof(int64_t));
	printf(/*4*/"alignof(Int64) = %zu\n", __alignof(int64_t));
	printf(/*4*/"sizeof(Int128) = %zu\n", sizeof(__int128));
	printf(/*4*/"alignof(Int128) = %zu\n", __alignof(__int128));
	// type Int256 not implemented
	//printf("sizeof(Int256) = %zu\n", sizeof(Int256))

	printf(/*4*/"sizeof(Char8) = %zu\n", sizeof(char));
	printf(/*4*/"alignof(Char8) = %zu\n", __alignof(char));
	printf(/*4*/"sizeof(Char16) = %zu\n", sizeof(char16_t));
	printf(/*4*/"alignof(Char16) = %zu\n", __alignof(char16_t));
	printf(/*4*/"sizeof(Char32) = %zu\n", sizeof(char32_t));
	printf(/*4*/"alignof(Char32) = %zu\n", __alignof(char32_t));

	// pointer size (for example pointer to []Char8)
	printf(/*4*/"sizeof(*Str8) = %zu\n", sizeof(char *));
	printf(/*4*/"alignof(*Str8) = %zu\n", __alignof(char *));

	// array size
	printf(/*4*/"sizeof([10]Int32) = %zu\n", sizeof(int32_t[10]));
	printf(/*4*/"alignof([10]Int32) = %zu\n", __alignof(int32_t[10]));

	printf(/*4*/"> alignof([3]Point) = %zu\n", __alignof(Point[3]));


	// record size
	printf(/*4*/"sizeof(Point) = %zu\n", sizeof(Point));
	printf(/*4*/"alignof(Point) = %zu\n", __alignof(Point));

	//	printf("offsetof(Point.x) = %llu\n", Nat64 offsetof(Point.x))
	//	printf("offsetof(Point.y) = %llu\n", Nat64 offsetof(Point.y))


	printf(/*4*/"sizeof(Mixed1) = %zu\n", sizeof(Mixed1));
	printf(/*4*/"alignof(Mixed1) = %zu\n", __alignof(Mixed1));

	printf(/*4*/"sizeof(Mixed2) = %zu\n", sizeof(Mixed2));
	printf(/*4*/"alignof(Mixed2) = %zu\n", __alignof(Mixed2));
	...
	printf(/*4*/"sizeof(Mixed3) = %zu\n", sizeof(Mixed3));
	printf(/*4*/"alignof(Mixed3) = %zu\n", __alignof(Mixed3));

	printf(/*4*/"sizeof(Mixed4) = %zu\n", sizeof(Mixed4));
	printf(/*4*/"alignof(Mixed4) = %zu\n", __alignof(Mixed4));
