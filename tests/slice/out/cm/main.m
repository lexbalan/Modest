...
func testFullRangeSlice () -> Bool {
	var a: [5]Int32 = [10, 20, 30, 40, 50]
	let s: [lengthof(a) - 0]Int32 = a[0:lengthof(a)]
...
func testSliceAssignWiderElementType () -> Bool {
	...
	let expected = [4]Nat64 [0, 111, 222]
	if a != expected {
