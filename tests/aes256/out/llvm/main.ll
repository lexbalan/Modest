...
declare %aes256_Result @aes256_encrypt_ecb(%aes256_Context* %ctx, %aes256_Block* %buf)
declare %aes256_Result @aes256_decrypt_ecb(%aes256_Context* %ctx, %aes256_Block* %buf)
