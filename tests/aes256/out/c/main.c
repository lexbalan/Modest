...
static struct test_case tests[8] = {
	...
	(struct test_case){
		...
		.plaintext = {0x30, 0xC8, 0x1C, 0x46, 0xA3, 0x5C, 0xE4, 0x11, 0xE5, 0xFB, 0xC1, 0x19, 0x1A, 0x0A, 0x52, 0xEF},
	...
	(struct test_case){
		...
		.ciphertext = {0x23, 0x30, 0x4B, 0x7A, 0x39, 0xF9, 0xF3, 0xFF, 0x06, 0x7D, 0x8D, 0x8F, 0x9E, 0x24, 0xEC, 0xC7}
	},
	(struct test_case){
		.key = {
		...
		.ciphertext = {0x46, 0xF2, 0xFB, 0x34, 0x2D, 0x6F, 0x0A, 0xB4, 0x77, 0x47, 0x6F, 0xC5, 0x01, 0x24, 0x2C, 0x5F}
	},
	(struct test_case){
		.key = {
