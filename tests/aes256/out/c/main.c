...
static struct test_case tests[8] = {
	...
	(struct test_case){
		...
		.ct = {0xF3, 0xEE, 0xD1, 0xBD, 0xB5, 0xD2, 0xA0, 0x3C, 0x6, 0x4B, 0x5A, 0x7E, 0x3D, 0xB1, 0x81, 0xF8}
	},
	(struct test_case){
		.key = {
			0x60, 0x3D, 0xEB, 0x10, 0x15, 0xCA, 0x71, 0xBE, 0x2B, 0x73, 0xAE, 0xF0, 0x85, 0x7D, 0x77, 0x81,
		...
		.pt = {0xAE, 0x2D, 0x8A, 0x57, 0x1E, 0x3, 0xAC, 0x9C, 0x9E, 0xB7, 0x6F, 0xAC, 0x45, 0xAF, 0x8E, 0x51},
	...
	(struct test_case){
		...
		.pt = {0x30, 0xC8, 0x1C, 0x46, 0xA3, 0x5C, 0xE4, 0x11, 0xE5, 0xFB, 0xC1, 0x19, 0x1A, 0xA, 0x52, 0xEF},
	...
	(struct test_case){
		...
		.ct = {0x23, 0x30, 0x4B, 0x7A, 0x39, 0xF9, 0xF3, 0xFF, 0x6, 0x7D, 0x8D, 0x8F, 0x9E, 0x24, 0xEC, 0xC7}
	},
	(struct test_case){
		.key = {
		...
		.pt = {0x0},
		.ct = {0x46, 0xF2, 0xFB, 0x34, 0x2D, 0x6F, 0xA, 0xB4, 0x77, 0x47, 0x6F, 0xC5, 0x1, 0x24, 0x2C, 0x5F}
	},
	(struct test_case){
		.key = {
	...
	(struct test_case){
		...
		.pt = {0x0},
		.ct = {0x9C, 0xF4, 0x89, 0x3E, 0xCA, 0xFA, 0xA, 0x2, 0x47, 0xA8, 0x98, 0xE0, 0x40, 0x69, 0x15, 0x59}
	}
};
