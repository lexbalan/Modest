...
type RGB24 record {red: Nat8, green: Nat8, blue: Nat8}
...
type AnimationPoint record {color: RGB24, time: Nat32}
...
type Wrap record {fhi: *(x: *Str8) -> Unit, fop: *(a: Int32, b: Int32) -> Int32}
