...
static int *a5[2] = (int *[2]){(int *)&a4[0], (int *)&a4[1]};
...
//]
static int *a7[2][5] = {
	(int32_t *)&a0, (int32_t *)&a0, (int32_t *)&a0, (int32_t *)&a0, (int32_t *)&a0,
	(int32_t *)&a0, (int32_t *)&a0, (int32_t *)&a0, (int32_t *)&a0, (int32_t *)&a0
};
static int *(*a8[2][5])[2][5] = {
	(int *(*)[5])(void *)&a7, (int *(*)[5])(void *)&a7, (int *(*)[5])(void *)&a7, (int *(*)[5])(void *)&a7, (int *(*)[5])(void *)&a7,
	(int *(*)[5])(void *)&a7, (int *(*)[5])(void *)&a7, (int *(*)[5])(void *)&a7, (int *(*)[5])(void *)&a7, (int *(*)[5])(void *)&a7
};
