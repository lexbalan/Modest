...
; -- strings --
@.str1 = private constant [13 x i8] [i8 99, i8 111, i8 100, i8 101, i8 32, i8 61, i8 32, i8 37, i8 48, i8 56, i8 120, i8 10, i8 0]
; -- endstrings --
%RGBA_Components = type {
	%Nat8,
	%Nat8,
	%Nat8,
	%Nat8
...
define %Int @main() {
	%1 = alloca %RGBA, align 4
	%2 = getelementptr %RGBA, %RGBA* %1, %Int32 0, %Int32 1, %Int32 0
	store %Nat8 255, %Nat8* %2
	%3 = getelementptr %RGBA, %RGBA* %1, %Int32 0, %Int32 1, %Int32 1
	store %Nat8 128, %Nat8* %3
	%4 = getelementptr %RGBA, %RGBA* %1, %Int32 0, %Int32 1, %Int32 2
	store %Nat8 64, %Nat8* %4
	%5 = getelementptr %RGBA, %RGBA* %1, %Int32 0, %Int32 1, %Int32 3
	store %Nat8 32, %Nat8* %5
	%6 = getelementptr %RGBA, %RGBA* %1, %Int32 0, %Int32 0
	%7 = load %Nat32, %Nat32* %6
	%8 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([13 x i8]* @.str1 to [0 x i8]*), %Nat32 %7)
	ret %Int 0
}
