...
define %Int @main() {
	...
	%54 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([26 x i8]* @str41 to [0 x i8]*), %Size 4)
	%55 = call %Int (%ConstCharStr*, ...) @printf(%ConstCharStr* bitcast ([27 x i8]* @str42 to [0 x i8]*), %Size 4)
