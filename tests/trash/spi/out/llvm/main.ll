...
; -- strings --
@str1 = private constant [12 x i8] [i8 120, i8 32, i8 61, i8 32, i8 48, i8 120, i8 37, i8 48, i8 50, i8 120, i8 10, i8 0]
; -- endstrings --
@data_line = internal global %Bool zeroinitializer
define internal void @clock_set(%Bool %x) {
	;
	ret void
}

define internal void @data_set(%Bool %x) {
	store %Bool %x, %Bool* @data_line
	ret void
}

define internal %Bool @data_get() {
	%1 = load %Bool, %Bool* @data_line
	ret %Bool %1
}

define internal void @delay(%Nat32 %x) {
	ret void
}
...
body_1:
	%5 = bitcast i8 1 to %Word8
	%6 = load %Nat8, %Nat8* %4
	%7 = bitcast %Nat8 %6 to %Word8
	%8 = shl %Word8 %5, %7
	%9 = and %Word8 %x, %8
...
endif_0:
	%23 = load %Nat8, %Nat8* %4
	%24 = sub %Nat8 %23, 1
	store %Nat8 %24, %Nat8* %4
	br label %again_1
break_1:
	%25 = load %Word8, %Word8* %2
	ret %Word8 %25
}
