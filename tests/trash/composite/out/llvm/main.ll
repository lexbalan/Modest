...
%main_He = type void ();
define internal void @main_he(%main_He* %x) {
	ret void
}
...
body_2:
	...
	%29 = getelementptr [3 x [3 x %Int32]], [3 x [3 x %Int32]]* @main_arrr, %Int32 0, %Nat32 %27, %Nat32 %28
...
break_2:
	...
	br label %again_1
break_1:
	%36 = getelementptr [2 x %Int32 (%Int32, %Int32)*], [2 x %Int32 (%Int32, %Int32)*]* @main_farr, %Int32 0, %Int32 0
	...
	%40 = getelementptr [2 x %Int32 (%Int32, %Int32)*], [2 x %Int32 (%Int32, %Int32)*]* @main_farr, %Int32 0, %Int32 1
...
body_3:
	...
	%48 = getelementptr [10 x void (%Str8*)*], [10 x void (%Str8*)*]* @main_hiarr, %Int32 0, %Nat32 %47
	...
	br label %again_3
break_3:
	%52 = getelementptr [2 x %main_Wrap*], [2 x %main_Wrap*]* @main_awrap, %Int32 0, %Int32 0
	%53 = load %main_Wrap*, %main_Wrap** %52
	%54 = getelementptr %main_Wrap, %main_Wrap* %53, %Int32 0, %Int32 0
