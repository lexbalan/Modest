...
define %Int @main() {
	...
	%3 = call %SSizeT (%Str8*, ...) @main_my_printf(%Str8* bitcast ([19 x i8]* @.str1 to [0 x i8]*), %Nat32 %2)
	...
	%8 = call %SSizeT (%Str8*, ...) @main_my_printf(%Str8* bitcast ([8 x i8]* @.str7 to [0 x i8]*), %Nat32 123)
	%9 = call %SSizeT (%Str8*, ...) @main_my_printf(%Str8* bitcast ([10 x i8]* @.str8 to [0 x i8]*), %Nat32 305419903)
	ret %Int 0
}
