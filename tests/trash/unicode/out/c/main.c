...
static char b8[1 + 1] = {'A'};
static char16_t b16[1 + 1] = {u'A'};
static char32_t b32[1 + 1] = {U'A'};
static char *s8 = A;
...
static char bb8[1 + 1] = {'A'};
static char16_t bb16[1 + 1] = {u'A'};
static char32_t bb32[1 + 1] = {U'A'};
static char *ss8 = "A";
