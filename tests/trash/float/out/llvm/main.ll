...
; -- endstrings --
define internal %Float64 @main_squareOfCircle(%Float64 %radius) {
...
define internal %Float32 @main_slope(%main_Point2D %a, %main_Point2D %b) {
...
define %Int @main() {
	...
	%4 = call %Float64 @main_squareOfCircle(%Float64 10.0000000000000000)
	...
	%13 = call %Float32 @main_slope(%main_Point2D %10, %main_Point2D %12)
