...
const nat8MaxPlusOne: Nat8 = Nat8 _nat8Max + 1
const nat8MinMinusOne: Nat8 = Nat8 _nat8Min - 1
const nat16MaxPlusOne: Nat16 = Nat16 _nat16Max + 1
const nat16MinMinusOne: Nat16 = Nat16 _nat16Min - 1
const nat32MaxPlusOne: Nat32 = Nat32 _nat32Max + 1
const nat32MinMinusOne: Nat32 = Nat32 _nat32Min - 1
const nat64MaxPlusOne: Nat64 = Nat64 _nat64Max + 1
const nat64MinMinusOne: Nat64 = Nat64 _nat64Min - 1
