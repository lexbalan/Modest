...
#define _NAT32_MIN  0
#define _NAT32_MAX  4294967295L
#define _NAT64_MIN  0
#define _NAT64_MAX  18446744073709551615LL
...
static void testInt32(void) {
	const int32_t min = (int32_t)(-2147483647 - 1);
...
static void testInt64(void) {
	const int64_t min = (int64_t)(-9223372036854775807LL - 1);
...
static void testNat32(void) {
	const uint32_t max = 4294967295L;
...
static void testNat64(void) {
	const uint64_t max = 18446744073709551615LL;
...
#define NAT8_MAX_PLUS_ONE  ((uint8_t)((uint8_t)_NAT8_MAX + 1))
#define NAT8_MIN_MINUS_ONE  ((uint8_t)((uint8_t)_NAT8_MIN - 1))
#define NAT16_MAX_PLUS_ONE  ((uint16_t)((uint16_t)_NAT16_MAX + 1))
#define NAT16_MIN_MINUS_ONE  ((uint16_t)((uint16_t)_NAT16_MIN - 1))
